...
<section class="section-band reveal-block" id="publications">
  <div class="section-head">
    <p class="section-kicker">Selected Publications</p>
    <h2>A compact set of papers that reflects the direction of my current work.</h2>
  </div>

  <div class="publication-list">
    <article class="publication-row">
      <div class="publication-row__image">
    ...
    <article class="publication-row">
      <div class="publication-row__image">
        <img src="/images/pub/TRB.png" alt="Transportation Research Record cover art">
      </div>
      <div class="publication-row__body">
        <p class="publication-row__meta">Transportation Research Record - 2022</p>
...
<section class="section-split-dual reveal-block">
  <div id="education">
    <div class="section-head section-head--compact">
      ...
      <h2>Academic training across engineering, management, and sustainability.</h2>
    </div>

    <div class="stack-panel">
      <article class="stack-item">
        <p class="stack-item__date">2025</p>
        <h3>Ph.D. in Sustainable Construction Management and Wood Science</h3>
        <p>SUNY College of Environmental Science and Forestry - Advisor: Dr. Paul Crovella</p>
      </article>
      <article class="stack-item">
        <p class="stack-item__date">2020</p>
        <h3>M.Eng. in Engineering Management</h3>
        <p>Stevens Institute of Technology</p>
      </article>
      <article class="stack-item">
        <p class="stack-item__date">2018</p>
        <h3>B.S. in Construction Engineering and Management</h3>
  ...
  <div>
    <div class="section-head section-head--compact">
      ...
      <h2>Open to collaboration and conversation.</h2>
    </div>
